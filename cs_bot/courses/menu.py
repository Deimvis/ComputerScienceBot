...
def build_course_list_menu():
    markup = types.InlineKeyboardMarkup()
    button_algorithms = types.InlineKeyboardButton('Алгоритмы и структуры данных',
                                                   callback_data=CallBuilder().make('courses', Course.ALGORITHMS))
    button_return = types.InlineKeyboardButton('Вернуться назад', callback_data=CallBuilder().make('start'))
    markup.add(button_algorithms)
...
course_list_menu = build_course_list_menu()
